...
export default function BillingReviewNotice({count}: {count: number}) {
  ...
  return <p className="text-sm text-warning border border-warning/30 rounded-lg p-3">
    ...
    {' '}Balances for those rentals include recorded invoices and payments only and may be incomplete. All records are retained. <Link href="/history" className="underline font-medium">View previous trailers and rentals</Link>
  </p>;
}
